 ...
 * The producer requires both server_id and signer_did to emit records; this
 * worker gates only on server_id because the signing-key component separately
 * validates a configured signer_did or generates an ephemeral development key.
 */
